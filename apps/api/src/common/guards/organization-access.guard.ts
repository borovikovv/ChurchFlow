...
export class OrganizationAccessGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    // Account state and membership in the requested organization come from one query;
    // only platform admins, who are rare, still need the second organization lookup.
